...
export const StoremanagerTableActions = ({ data }: { data: AdminDashboardData}) => {
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-start justify-between">
              <div className="space-y-2 flex-1 border-r-[1px] border-solid pl-2">
                ...
                <p><strong>配送リーダー承認:</strong> {data.startLeader.lastName || '未承認'}</p>
                <p><strong>NSマネージャー承認:</strong> {data.startNsManager.lastName || '未承認'}</p>
                <p><strong>店長承認:</strong> {data.startStoreManager.id ? '済' : '未承認'}</p>
              ...
              <div className="space-y-2 flex-1 pl-2">
                ...
                <p><strong>配送リーダー承認:</strong> {data.endLeader.lastName || '未承認'}</p>
                <p><strong>NSマネージャー承認:</strong> {data.endNsManager.lastName || '未承認'}</p>
                <p><strong>店長承認:</strong> {data.endStoreManager.id ? '済' : '未承認'}</p>
